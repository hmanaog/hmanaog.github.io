...
import { Box, Grid, Card, CardContent, CardMedia, Typography, CircularProgress } from '@material-ui/core';
            ...
            <Grid container spacing={3}>
               <Grid item xs={12} sm={6} style={{ display: 'flex', justifyContent: 'center' }}>
                  <Box className={classes.cardMediaBox}>
                     <CardMedia component='img' image={article.imageUrl} title={article.title} />
                  </Box>
               </Grid>
